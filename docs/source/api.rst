...
- :ref:`smol.cofe` (Cluster Orbit Fourier Expansion) includes classes and
  functions to define, train and test cluster expansions.
- :ref:`smol.moca` (Monte Carlo) includes classes and functions to run MCMC
...
You can also refer to (autogenerated) :ref:`fulldocs` for
