        ...
        for i in range(len(corr_in)):
            ...
            if i not in structure_index_at_hull and i not in duplicated_correlation_set:
                ...
                if reduced_comp in reduce_composition_at_hull:  ## in hull composition
                    ...
                    ele_comp_now = self.structures[i].composition.element_composition.reduced_composition.element_composition
                ...
                vertices_red_composition_list_new_pd = [pd_new.qhull_entries[i].composition.element_composition.reduced_composition.element_composition 
