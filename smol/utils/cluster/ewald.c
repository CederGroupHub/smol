...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "language": "c",
        "name": "smol.utils.cluster.ewald",
        "sources": [
            "smol/utils/cluster/ewald.pyx"
        ]
    },
    "module_name": "smol.utils.cluster.ewald"
}
END: Cython Metadata */
...
#define __PYX_HAVE__smol__utils__cluster__ewald
#define __PYX_HAVE_API__smol__utils__cluster__ewald
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'smol.utils.cluster.ewald' */
...
static PyObject *__pyx_f_4smol_5utils_7cluster_5ewald_delta_ewald_single_flip(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int const , int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "smol.utils.cluster.ewald"
extern int __pyx_module_is_main_smol__utils__cluster__ewald;
int __pyx_module_is_main_smol__utils__cluster__ewald = 0;

/* Implementation of 'smol.utils.cluster.ewald' */
...
static const char __pyx_k_William_D_Richards[] = "William D. Richards";
...
static const char __pyx_k_Cython_function_to_compute_the_c[] = "Cython function to compute the change in electrostatic energy from a flips.";
...
static PyObject *__pyx_kp_u_William_D_Richards;
...
static PyObject *__pyx_pf_4smol_5utils_7cluster_5ewald_delta_ewald_single_flip(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_occu_f, __Pyx_memviewslice __pyx_v_occu_i, __Pyx_memviewslice __pyx_v_ewald_matrix, __Pyx_memviewslice __pyx_v_ewald_indices, int __pyx_v_site_ind); /* proto */
...
/* "smol/utils/cluster/ewald.pyx":6
 *
 *
...
static PyObject *__pyx_pw_4smol_5utils_7cluster_5ewald_1delta_ewald_single_flip(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_4smol_5utils_7cluster_5ewald_delta_ewald_single_flip(__Pyx_memviewslice __pyx_v_occu_f, __Pyx_memviewslice __pyx_v_occu_i, __Pyx_memviewslice __pyx_v_ewald_matrix, __Pyx_memviewslice __pyx_v_ewald_indices, int const __pyx_v_site_ind, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  int __pyx_v_add;
  ...
  /* "smol/utils/cluster/ewald.pyx":31
 ...
 */
  ...
  /* "smol/utils/cluster/ewald.pyx":35
 *
 ...
 */
  ...
  /* "smol/utils/cluster/ewald.pyx":36
 *     # values of -1 are vacancies and hence don't have ewald indices
 *     add = ewald_indices[site_ind, occu_f[site_ind]]
 *     sub = ewald_indices[site_ind, occu_i[site_ind]]             # <<<<<<<<<<<<<<
 *
 ...
 */
  ...
  /* "smol/utils/cluster/ewald.pyx":38
 *     sub = ewald_indices[site_ind, occu_i[site_ind]]
 *
 *     for k in range(occu_f.shape[0]):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
    ...
    /* "smol/utils/cluster/ewald.pyx":39
 *
 *     for k in range(occu_f.shape[0]):
 *         i = ewald_indices[k, occu_f[k]]             # <<<<<<<<<<<<<<
 *         out_k = 0
 ...
 */
    ...
    /* "smol/utils/cluster/ewald.pyx":40
 *     for k in range(occu_f.shape[0]):
 *         i = ewald_indices[k, occu_f[k]]
 *         out_k = 0             # <<<<<<<<<<<<<<
 *         if i != -1 and add != -1:
 ...
 */
    ...
    /* "smol/utils/cluster/ewald.pyx":41
 *         i = ewald_indices[k, occu_f[k]]
 *         out_k = 0
 *         if i != -1 and add != -1:             # <<<<<<<<<<<<<<
 *             if i != add:
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "smol/utils/cluster/ewald.pyx":42
 *         out_k = 0
 *         if i != -1 and add != -1:
 *             if i != add:             # <<<<<<<<<<<<<<
 *                 out_k = out_k + 2 * ewald_matrix[i, add]
 ...
 */
      ...
      if (__pyx_t_7) {
        ...
        /* "smol/utils/cluster/ewald.pyx":43
 *         if i != -1 and add != -1:
 *             if i != add:
 *                 out_k = out_k + 2 * ewald_matrix[i, add]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "smol/utils/cluster/ewald.pyx":45
 *                 out_k = out_k + 2 * ewald_matrix[i, add]
 *             else:
 *                 out_k = out_k + ewald_matrix[i, add]             # <<<<<<<<<<<<<<
 *
 ...
 */
    ...
    /* "smol/utils/cluster/ewald.pyx":47
 *                 out_k = out_k + ewald_matrix[i, add]
 *
 *         j = ewald_indices[k, occu_i[k]]             # <<<<<<<<<<<<<<
 *         if j != -1 and sub != -1:
 ...
 */
    ...
    /* "smol/utils/cluster/ewald.pyx":48
 *
 *         j = ewald_indices[k, occu_i[k]]
 *         if j != -1 and sub != -1:             # <<<<<<<<<<<<<<
 *             if j != sub:
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "smol/utils/cluster/ewald.pyx":49
 *         j = ewald_indices[k, occu_i[k]]
 *         if j != -1 and sub != -1:
 *             if j != sub:             # <<<<<<<<<<<<<<
 *                 out_k = out_k - 2 * ewald_matrix[j, sub]
 ...
 */
      ...
      if (__pyx_t_7) {
        ...
        /* "smol/utils/cluster/ewald.pyx":50
 *         if j != -1 and sub != -1:
 *             if j != sub:
 *                 out_k = out_k - 2 * ewald_matrix[j, sub]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "smol/utils/cluster/ewald.pyx":52
 *                 out_k = out_k - 2 * ewald_matrix[j, sub]
 *             else:
 *                 out_k = out_k - ewald_matrix[j, sub]             # <<<<<<<<<<<<<<
 *         out += out_k
 ...
 */
    ...
    /* "smol/utils/cluster/ewald.pyx":53
 *             else:
 *                 out_k = out_k - ewald_matrix[j, sub]
 *         out += out_k             # <<<<<<<<<<<<<<
 *     return out
 */
  ...
  /* "smol/utils/cluster/ewald.pyx":54
 *                 out_k = out_k - ewald_matrix[j, sub]
 *         out += out_k
 *     return out             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_9 = PyFloat_FromDouble(__pyx_v_out); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 54, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("smol.utils.cluster.ewald.delta_ewald_single_flip", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyObject *__pyx_pw_4smol_5utils_7cluster_5ewald_1delta_ewald_single_flip(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("delta_ewald_single_flip (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_occu_i)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("delta_ewald_single_flip", 1, 5, 5, 1); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ewald_matrix)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("delta_ewald_single_flip", 1, 5, 5, 2); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ewald_indices)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("delta_ewald_single_flip", 1, 5, 5, 3); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_site_ind)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("delta_ewald_single_flip", 1, 5, 5, 4); __PYX_ERR(0, 6, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "delta_ewald_single_flip") < 0)) __PYX_ERR(0, 6, __pyx_L3_error)
      }
    ...
    __pyx_v_occu_f = __Pyx_PyObject_to_MemoryviewSlice_dc_long__const__(values[0], 0); if (unlikely(!__pyx_v_occu_f.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_occu_i = __Pyx_PyObject_to_MemoryviewSlice_dc_long__const__(values[1], 0); if (unlikely(!__pyx_v_occu_i.memview)) __PYX_ERR(0, 7, __pyx_L3_error)
    __pyx_v_ewald_matrix = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double__const__(values[2], 0); if (unlikely(!__pyx_v_ewald_matrix.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_ewald_indices = __Pyx_PyObject_to_MemoryviewSlice_d_dc_long__const__(values[3], 0); if (unlikely(!__pyx_v_ewald_indices.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_site_ind = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_site_ind == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("delta_ewald_single_flip", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("smol.utils.cluster.ewald.delta_ewald_single_flip", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4smol_5utils_7cluster_5ewald_delta_ewald_single_flip(__pyx_self, __pyx_v_occu_f, __pyx_v_occu_i, __pyx_v_ewald_matrix, __pyx_v_ewald_indices, __pyx_v_site_ind);
...
static PyObject *__pyx_pf_4smol_5utils_7cluster_5ewald_delta_ewald_single_flip(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_occu_f, __Pyx_memviewslice __pyx_v_occu_i, __Pyx_memviewslice __pyx_v_ewald_matrix, __Pyx_memviewslice __pyx_v_ewald_indices, int __pyx_v_site_ind) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("delta_ewald_single_flip", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4smol_5utils_7cluster_5ewald_delta_ewald_single_flip(__pyx_v_occu_f, __pyx_v_occu_i, __pyx_v_ewald_matrix, __pyx_v_ewald_indices, __pyx_v_site_ind, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "smol.utils.cluster.ewald.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "smol.utils.cluster.ewald.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "smol.utils.cluster.ewald.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "smol.utils.cluster.ewald._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"delta_ewald_single_flip", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4smol_5utils_7cluster_5ewald_1delta_ewald_single_flip, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4smol_5utils_7cluster_5ewald_delta_ewald_single_flip},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_ewald(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_ewald},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "ewald",
    __pyx_k_Cython_function_to_compute_the_c, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_u_William_D_Richards, __pyx_k_William_D_Richards, sizeof(__pyx_k_William_D_Richards), 0, 1, 0, 0},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initewald(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initewald(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_ewald(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_ewald(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_ewald(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'ewald' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_ewald(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("ewald", __pyx_methods, __pyx_k_Cython_function_to_compute_the_c, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_smol__utils__cluster__ewald) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "smol.utils.cluster.ewald")) {
      if (unlikely(PyDict_SetItemString(modules, "smol.utils.cluster.ewald", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "smol/utils/cluster/ewald.pyx":3
 ...
 *
 */
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_author, __pyx_kp_u_William_D_Richards) < 0) __PYX_ERR(0, 3, __pyx_L1_error)

  /* "smol/utils/cluster/ewald.pyx":1
 * """Cython function to compute the change in electrostatic energy from a flips."""             # <<<<<<<<<<<<<<
 *
 * __author__ = "William D. Richards"
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init smol.utils.cluster.ewald", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init smol.utils.cluster.ewald");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
