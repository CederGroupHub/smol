...
static PyObject *__pyx_f_4smol_5utils_7cluster_12correlations_indicator_delta_corr_single_flip(__Pyx_memviewslice, __Pyx_memviewslice, int const , PyObject *, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_4smol_5utils_7cluster_12correlations_4indicator_delta_corr_single_flip(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_occu_f, __Pyx_memviewslice __pyx_v_occu_i, int __pyx_v_num_corr_functions, PyObject *__pyx_v_site_orbit_list); /* proto */
 ...
 */
  ...
  /* "smol/utils/cluster/correlations.pyx":90
 *     cdef const double[:, ::1] corr_tensors
 *     out = np.zeros(num_corr_functions)
 *     cdef double[::1] o_view = out             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "smol/utils/cluster/correlations.pyx":106
 *             o_view[n] = p / ratio / I
 *             n += 1
 *     return out             # <<<<<<<<<<<<<<
 * 
...
/* "smol/utils/cluster/correlations.pyx":109
 * 
 * 
...
static PyObject *__pyx_pw_4smol_5utils_7cluster_12correlations_5indicator_delta_corr_single_flip(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_4smol_5utils_7cluster_12correlations_indicator_delta_corr_single_flip(__Pyx_memviewslice __pyx_v_occu_f, __Pyx_memviewslice __pyx_v_occu_i, int const __pyx_v_num_corr_functions, PyObject *__pyx_v_site_orbit_list, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  int __pyx_v_n;
  ...
  /* "smol/utils/cluster/correlations.pyx":135
 ...
 */
  ...
  /* "smol/utils/cluster/correlations.pyx":136
 *     cdef const long[::1] bit_indices
 *     out = np.zeros(num_corr_functions)
 *     cdef double[::1] o_view = out             # <<<<<<<<<<<<<<
 *     cdef double r, o
 ...
 */
  ...
  /* "smol/utils/cluster/correlations.pyx":139
 *     cdef double r, o
 * 
 ...
 */
  ...
  for (;;) {
    ...
    /* "smol/utils/cluster/correlations.pyx":140
 * 
 *     for n, r, bit_combos, bit_indices, _, indices in site_orbit_list:
 *         M = bit_indices.shape[0] # index of bit combos             # <<<<<<<<<<<<<<
 *         I = indices.shape[0] # cluster index
 ...
 */
    ...
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_19; __pyx_t_13+=1) {
      ...
      /* "smol/utils/cluster/correlations.pyx":144
 *         K = indices.shape[1] # index within cluster
 *         for m in range(M - 1):
 *             o = 0             # <<<<<<<<<<<<<<
 *             for i in range(I):
 ...
 */
      ...
      /* "smol/utils/cluster/correlations.pyx":163
 *                         o -= 1
 * 
 *             o_view[n] = o / r / (I * (bit_indices[m + 1] - bit_indices[m]))             # <<<<<<<<<<<<<<
 *             n += 1
 ...
 */
  ...
  /* "smol/utils/cluster/correlations.pyx":165
 *             o_view[n] = o / r / (I * (bit_indices[m + 1] - bit_indices[m]))
 *             n += 1
 *     return out             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("smol.utils.cluster.correlations.indicator_delta_corr_single_flip", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_bit_combos, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_indices, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_4smol_5utils_7cluster_12correlations_5indicator_delta_corr_single_flip(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4smol_5utils_7cluster_12correlations_4indicator_delta_corr_single_flip[] = "Local change in indicator basis correlation vector from single flip.\n\n    Args:\n        occu_f (ndarray):\n            encoded occupancy vector with flip\n        occu_i (ndarray):\n            encoded occupancy vector without flip\n        num_corr_functions (int):\n            total number of bit orderings in expansion.\n        site_orbit_list:\n            Information of all orbits that include the flip site.\n            List of tuples each with\n            (orbit id, cluster ratio, bit_combos,\n             bit_combo_indices site indices, bases array)\n\n    Returns:\n        ndarray: correlation vector difference\n    ";
static PyObject *__pyx_pw_4smol_5utils_7cluster_12correlations_5indicator_delta_corr_single_flip(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_occu_f = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_occu_i = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_num_corr_functions;
  PyObject *__pyx_v_site_orbit_list = 0;
  ...
  __pyx_r = __pyx_pf_4smol_5utils_7cluster_12correlations_4indicator_delta_corr_single_flip(__pyx_self, __pyx_v_occu_f, __pyx_v_occu_i, __pyx_v_num_corr_functions, __pyx_v_site_orbit_list);
...
static PyObject *__pyx_pf_4smol_5utils_7cluster_12correlations_4indicator_delta_corr_single_flip(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_occu_f, __Pyx_memviewslice __pyx_v_occu_i, int __pyx_v_num_corr_functions, PyObject *__pyx_v_site_orbit_list) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("indicator_delta_corr_single_flip", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4smol_5utils_7cluster_12correlations_indicator_delta_corr_single_flip(__pyx_v_occu_f, __pyx_v_occu_i, __pyx_v_num_corr_functions, __pyx_v_site_orbit_list, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "smol/utils/cluster/correlations.pyx":168
 * 
 * 
...
static PyObject *__pyx_f_4smol_5utils_7cluster_12correlations_interactions_from_occupancy(__Pyx_memviewslice __pyx_v_occu, int const __pyx_v_num_interactions, double const __pyx_v_offset, PyObject *__pyx_v_orbit_list, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "smol/utils/cluster/correlations.pyx":192
 *     cdef const long[::1] tensor_indices
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_num_interactions); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 192, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_3))) {
    __pyx_t_4 = PyMethod_GET_SELF(__pyx_t_3);
 ...
 * 
 */
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_out, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 193, __pyx_L1_error)
  __pyx_v_o_view = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;
 ...
 */
  ...
  for (;;) {
    ...
    if ((likely(PyTuple_CheckExact(__pyx_t_3))) || (PyList_CheckExact(__pyx_t_3))) {
      ...
      __pyx_t_8 = PySequence_ITEM(sequence, 2); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 197, __pyx_L1_error)
    ...
    __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_dc_long__const__(__pyx_t_2, 0); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 197, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_12 = __Pyx_PyObject_to_MemoryviewSlice_dc_double__const__(__pyx_t_4, 0); if (unlikely(!__pyx_t_12.memview)) __PYX_ERR(0, 197, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_13 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_long__const__(__pyx_t_8, 0); if (unlikely(!__pyx_t_13.memview)) __PYX_ERR(0, 197, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __PYX_XDEC_MEMVIEW(&__pyx_v_tensor_indices, 1);
 ...
 */
      ...
      /* "smol/utils/cluster/correlations.pyx":205
 *             for j in range(J):
 *                 index += tensor_indices[j] * occu[indices[i, j]]
 *             p += interaction_tensors[index]             # <<<<<<<<<<<<<<
 *         o_view[n] = p / I
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_o_view.data + __pyx_t_21 * __pyx_v_o_view.strides[0]) )) = (__pyx_v_p / ((double)__pyx_v_I));
    ...
    /* "smol/utils/cluster/correlations.pyx":207
 *             p += interaction_tensors[index]
 *         o_view[n] = p / I
 *         n += 1             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pw_4smol_5utils_7cluster_12correlations_7interactions_from_occupancy(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("interactions_from_occupancy (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_interactions)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("interactions_from_occupancy", 1, 4, 4, 1); __PYX_ERR(0, 168, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_offset)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("interactions_from_occupancy", 1, 4, 4, 2); __PYX_ERR(0, 168, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_orbit_list)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("interactions_from_occupancy", 1, 4, 4, 3); __PYX_ERR(0, 168, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "interactions_from_occupancy") < 0)) __PYX_ERR(0, 168, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 4) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_occu = __Pyx_PyObject_to_MemoryviewSlice_dc_long__const__(values[0], 0); if (unlikely(!__pyx_v_occu.memview)) __PYX_ERR(0, 168, __pyx_L3_error)
    __pyx_v_num_interactions = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_num_interactions == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 169, __pyx_L3_error)
    __pyx_v_offset = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_offset == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 170, __pyx_L3_error)
    __pyx_v_orbit_list = ((PyObject*)values[3]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("interactions_from_occupancy", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 168, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("smol.utils.cluster.correlations.interactions_from_occupancy", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_orbit_list), (&PyList_Type), 1, "orbit_list", 1))) __PYX_ERR(0, 171, __pyx_L1_error)
...
static PyObject *__pyx_pf_4smol_5utils_7cluster_12correlations_6interactions_from_occupancy(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_occu, int __pyx_v_num_interactions, double __pyx_v_offset, PyObject *__pyx_v_orbit_list) {
  ...
  __Pyx_RefNannySetupContext("interactions_from_occupancy", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4smol_5utils_7cluster_12correlations_interactions_from_occupancy(__pyx_v_occu, __pyx_v_num_interactions, __pyx_v_offset, __pyx_v_orbit_list, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 168, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "smol/utils/cluster/correlations.pyx":212
 * 
 * 
 ...
 */
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_v_out, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 239, __pyx_L1_error)
  __pyx_v_o_view = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;
 ...
 */
  ...
  for (;;) {
    if (__pyx_t_6 >= PyList_GET_SIZE(__pyx_t_1)) break;
    #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
    __pyx_t_3 = PyList_GET_ITEM(__pyx_t_1, __pyx_t_6); __Pyx_INCREF(__pyx_t_3); __pyx_t_6++; if (unlikely(0 < 0)) __PYX_ERR(0, 241, __pyx_L1_error)
    #else
    __pyx_t_3 = PySequence_ITEM(__pyx_t_1, __pyx_t_6); __pyx_t_6++; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 241, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    #endif
    if ((likely(PyTuple_CheckExact(__pyx_t_3))) || (PyList_CheckExact(__pyx_t_3))) {
      PyObject* sequence = __pyx_t_3;
      ...
      Py_ssize_t index = -1;
      PyObject** temps[5] = {&__pyx_t_2,&__pyx_t_4,&__pyx_t_7,&__pyx_t_8,&__pyx_t_9};
      __pyx_t_10 = PyObject_GetIter(__pyx_t_3); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 241, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_11 = Py_TYPE(__pyx_t_10)->tp_iternext;
      for (index=0; index < 5; index++) {
      ...
      if (__Pyx_IternextUnpackEndCheck(__pyx_t_11(__pyx_t_10), 5) < 0) __PYX_ERR(0, 241, __pyx_L1_error)
      __pyx_t_11 = NULL;
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      goto __pyx_L6_unpacking_done;
      __pyx_L5_unpacking_failed:;
    ...
    __pyx_t_12 = __Pyx_PyInt_As_int(__pyx_t_2); if (unlikely((__pyx_t_12 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 241, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    ...
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_14 = __Pyx_PyObject_to_MemoryviewSlice_dc_long__const__(__pyx_t_7, 0); if (unlikely(!__pyx_t_14.memview)) __PYX_ERR(0, 241, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_15 = __Pyx_PyObject_to_MemoryviewSlice_dc_double__const__(__pyx_t_8, 0); if (unlikely(!__pyx_t_15.memview)) __PYX_ERR(0, 241, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_16 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_long__const__(__pyx_t_9, 0); if (unlikely(!__pyx_t_16.memview)) __PYX_ERR(0, 241, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_v_n = __pyx_t_12;
    __pyx_v_ratio = __pyx_t_13;
    __PYX_XDEC_MEMVIEW(&__pyx_v_tensor_indices, 1);
 ...
 */
      ...
      /* "smol/utils/cluster/correlations.pyx":250
 *                 ind_i += tensor_indices[j] * occu_i[indices[i, j]]
 *                 ind_f += tensor_indices[j] * occu_f[indices[i, j]]
 *             p += (interaction_tensor[ind_f] - interaction_tensor[ind_i])             # <<<<<<<<<<<<<<
 *         o_view[n] = p / ratio / I
 ...
 */
    ...
    /* "smol/utils/cluster/correlations.pyx":251
 *                 ind_f += tensor_indices[j] * occu_f[indices[i, j]]
 *             p += (interaction_tensor[ind_f] - interaction_tensor[ind_i])
 *         o_view[n] = p / ratio / I             # <<<<<<<<<<<<<<
 *     return out
...
static PyObject *__pyx_pw_4smol_5utils_7cluster_12correlations_9delta_interactions_single_flip(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("delta_interactions_single_flip (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_occu_i)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("delta_interactions_single_flip", 1, 4, 4, 1); __PYX_ERR(0, 212, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_interactions)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("delta_interactions_single_flip", 1, 4, 4, 2); __PYX_ERR(0, 212, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_site_orbit_list)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("delta_interactions_single_flip", 1, 4, 4, 3); __PYX_ERR(0, 212, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "delta_interactions_single_flip") < 0)) __PYX_ERR(0, 212, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 4) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_occu_f = __Pyx_PyObject_to_MemoryviewSlice_dc_long__const__(values[0], 0); if (unlikely(!__pyx_v_occu_f.memview)) __PYX_ERR(0, 212, __pyx_L3_error)
    __pyx_v_occu_i = __Pyx_PyObject_to_MemoryviewSlice_dc_long__const__(values[1], 0); if (unlikely(!__pyx_v_occu_i.memview)) __PYX_ERR(0, 213, __pyx_L3_error)
    __pyx_v_num_interactions = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_num_interactions == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 214, __pyx_L3_error)
    __pyx_v_site_orbit_list = ((PyObject*)values[3]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("delta_interactions_single_flip", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 212, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("smol.utils.cluster.correlations.delta_interactions_single_flip", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_site_orbit_list), (&PyList_Type), 1, "site_orbit_list", 1))) __PYX_ERR(0, 215, __pyx_L1_error)
...
static PyObject *__pyx_pf_4smol_5utils_7cluster_12correlations_8delta_interactions_single_flip(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_occu_f, __Pyx_memviewslice __pyx_v_occu_i, int __pyx_v_num_interactions, PyObject *__pyx_v_site_orbit_list) {
  ...
  __Pyx_RefNannySetupContext("delta_interactions_single_flip", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4smol_5utils_7cluster_12correlations_delta_interactions_single_flip(__pyx_v_occu_f, __pyx_v_occu_i, __pyx_v_num_interactions, __pyx_v_site_orbit_list, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 212, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  ...
  {"indicator_delta_corr_single_flip", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4smol_5utils_7cluster_12correlations_5indicator_delta_corr_single_flip, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4smol_5utils_7cluster_12correlations_4indicator_delta_corr_single_flip},
