...
class SampleContainer(MSONable):
    ...
    def sampling_efficiency(self, discard=0, flat=True):
        """Return the sampling efficiency for chains. If the sampling is thinned
        by > 1, this value becomes only an estimate for the true sampling efficiency,
        as we do not know the efficiency of the discarded samples."""
