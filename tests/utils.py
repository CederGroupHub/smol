...
def assert_msonable(test_case, obj, test_if_subclass=True):
    """
    ...
    """
    if test_if_subclass:
        test_case.assertIsInstance(obj, MSONable)
    test_case.assertDictEqual(obj.as_dict(), obj.__class__.from_dict(
        obj.as_dict()).as_dict())
