...
def test_combined_flip(sublattices_cn,flip_combinations):
    tf = Combinedflipper(sublattices,flip_combinations)
    ...
    for i in range(28000):
        ...
        direction = direction_from_step(occu,step,tf.sl_list)
...
def test_charge_neutral_flip(sublattices_cn):
    cf = Chargeneutralflipper(sublattices_cn)
